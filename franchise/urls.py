...
from .views import MarkOrderServedView,TableOrderAPIView,TableAPIView,CustomerAPIView,OrderAPIView,orders_view,table_view,show_table_order,CustomerFingerAPIView,PaymentAPIView,MakePaymentAPIView
